...
# # with c2:
# #     st.write("Austria")
# #     #st.markdown("<p style = 'text-align: center'> Austria </p>", unsafe_allow_html=True)
...
# import streamlit as st
# import pandas as pd
# from scripts.preprocess import preprocess__
# from scripts.model_file import get_images
# import random
